...
// function getEaEb(tknPath, pairs) {
//     let Ea = pairs[0].reserves[tknPath[0]]
//     let Eb = pairs[0].reserves[tknPath[1]]
//     console.log(Ea.toString(), Eb.toString())
//     for (let i=1; i<pairs.length; i++) {
//         Rb1 = pairs[i].reserves[tknPath[i]]
//         Rc = pairs[i].reserves[tknPath[i+1]]
//         console.log(Rb1.toString(), Rc.toString())
