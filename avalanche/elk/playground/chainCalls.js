...
async function getFactoryFromRouter() {
    let address = '0x9E4AAbd2B3E60Ee1322E94307d0776F2c8e6CFbb'
    let routerContract = new ethers.Contract(address, config.ABIS['uniswapRouter'], providers.ws.provider)
    let factory = await routerContract.factory()
    console.log(factory)
}

// 0x091d35d7F63487909C863001ddCA481c6De47091
getFactoryFromRouter()
